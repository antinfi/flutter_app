...
Future<DateTime?> openCustomDatePicker({DateTime? selectedDate, DateTime? minimumDate, DateTime? maximumDate}) =>
    Get.dialog<DateTime>(DateSelectionDialog(selectedDate, minimumDate: minimumDate, maximumDate: maximumDate));
...
class DateSelectionDialog extends StatefulWidget {
  ...
  const DateSelectionDialog(this.selectedDate, {this.minimumDate, this.maximumDate, super.key});
...
class _DateSelectionDialogState extends State<DateSelectionDialog> {
  ...
  final scrollViewDetailOptions = const ScrollViewDetailOptions(
    margin: EdgeInsets.all(12),
    alignment: Alignment.center,
    textStyle: AppTextStyle.dateTextStyle,
    selectedTextStyle: AppTextStyle.selectedDateTextStyle,
  );
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Row(children: [
                  const Gap(24),
                  Expanded(child: AppButton.cancel(onTap: Get.back)),
                  const Gap(16),
                  Expanded(child: AppButton.confirm(onTap: () => Get.back(result: _selectedDate))),
                  const Gap(24),
                ]),
                const Gap(24),
              ],
...
class ScrollDatePicker extends StatefulWidget {
  ScrollDatePicker({
    ...
    this.indicator,
    Key? key,
  })  : minimumDate = minimumDate ?? DateTime(1960),
...
class _ScrollDatePickerState extends State<ScrollDatePicker> {
  ...
  void _initDays() {
    final maximumDay = getMonthlyDate(year: _selectedDate.year, month: _selectedDate.month);
